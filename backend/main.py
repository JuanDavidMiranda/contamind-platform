...
from app.models import accounting as accounting_models  # noqa: F401  (registra modelos para create_all)
from app.models import agent as agent_models  # noqa: F401  (registra modelos para create_all)
