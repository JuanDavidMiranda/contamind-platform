...
class InvoiceRecord(Base):
    ...
    electronic_status: Mapped[str | None] = mapped_column(String(50), nullable=True)
    electronic_reference: Mapped[str | None] = mapped_column(String(255), nullable=True)
    electronic_status_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    idempotency_key: Mapped[str] = mapped_column(String(128))
    created_by_user_id: Mapped[int] = mapped_column(ForeignKey("users.id"), index=True)
